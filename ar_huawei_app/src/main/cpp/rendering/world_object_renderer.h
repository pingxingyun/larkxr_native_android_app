...
namespace gWorldAr {
    ...
    public:
        ...
        // Initialize the OpenGL state, load files and textures, and set the OpenGL resources for drawing the model.
        ...
        // @param viewMat Virtual object model information matrix.
