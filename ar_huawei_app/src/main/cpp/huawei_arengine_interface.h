 ...
 * Description: The AREngine ndk api.
 * Author: j00428315
 * Create: 2018-04-09
 */
...
HWAR_DEFINE_ENUM(HwArServiceState) {
    HWAR_CLOUD_IMAGE_NORMAL = 10000,
    HWAR_CLOUD_IMAGE_ERROR_NETWORK_UNAVAILABLE = 10001,
    HWAR_CLOUD_IMAGE_ERROR_CLOUD_SERVICE_UNAVAILABLE = 10002,
    HWAR_CLOUD_IMAGE_ERROR_NOT_AUTHORIZED = 10003,
    HWAR_CLOUD_IMAGE_ERROR_SERVER_VERSION_TOO_OLD = 10004,
    HWAR_CLOUD_IMAGE_ERROR_TIME_EXHAUSTED = 10005,
    HWAR_CLOUD_IMAGE_ERROR_IMAGE_GALLERY_INVALID = 10006,
    HWAR_CLOUD_IMAGE_ERROR_INTERNAL = 10007,
};
...
void HwArConfig_getLightEstimationMode(const HwArSession *session,
                                       const HwArConfig *config,
                                       HwArLightEstimationMode *lightEstimationMode);
